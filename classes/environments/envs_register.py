...
_register('Env_RILC_el',       'classes.environments.env_rlilc_elastic:Env_RILC')
_register('Env_RL_el',         'classes.environments.env_rlilc_elastic:Env_RL')
_register('Env_RILC_RANGE_el', 'classes.environments.env_rlilc_elastic:Env_RILC_RANGE')
_register('Env_RL_RANGE_el',   'classes.environments.env_rlilc_elastic:Env_RL_RANGE')
